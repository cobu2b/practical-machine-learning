...
Random forest is used because it provides a high-accuracy model; however, it may introduce overfitting. PCA and cross validation help alleviate the overfitting issue.
```{r, echo=TRUE, cache=TRUE, warning=FALSE}
